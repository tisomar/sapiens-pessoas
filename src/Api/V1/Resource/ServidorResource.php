...
use AguPessoas\Backend\Entity\Servidor as ServidorEntity;
use AguPessoas\Backend\Entity\EntityInterface;
use AguPessoas\Backend\Repository\ServidorRepository as Repository;
...
class ServidorResource extends RestResource
{
    ...
    public function __construct(
        ...
        $this->setDtoClass(Servidor::class);
    }
}
