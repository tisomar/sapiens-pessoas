 ...
 */
#[DTOMapper\JsonLD(
    jsonLDId: '/v1/regiao_administrativa/{id}',
    jsonLDType: 'RegiaoAdministrativa',
    jsonLDContext: '/api/doc/#model-RegiaoAdministrativa'
)]
#[Form\Form]
//#[Form\Cacheable(expire: 86400)]
class RegiaoAdministrativa extends RestDto
{
