...
/**
 * /src/Api/V1/DTO/SPSigepeCondicao.php.
 *
...
/**
 * Class SPSigepeCondicao.
 *
 * @author Advocacia-Geral da União
 */
#[DTOMapper\JsonLD(
    jsonLDId: '/v2/dependente/condicao/{id}',
    jsonLDType: 'Condicao',
    jsonLDContext: '/api/doc/#model-SPSigepeCondicao'
)]
#[Form\Form]
//#[Form\Cacheable(expire: 86400)]
class SPSigepeCondicao extends RestDto
{
    use IdUuid;
    use CodigoSigepe;
    use Nome;
