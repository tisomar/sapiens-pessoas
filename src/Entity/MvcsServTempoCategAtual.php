...
/**
 * MvcsServTempoCategAtual
 */
#[ORM\Table(name: 'MVCS_SERV_TEMPO_CATEG_ATUAL')]
#[ORM\Entity]
class MvcsServTempoCategAtual
{
    /**
     * @var int
     */
    ...
    #[ORM\SequenceGenerator(sequenceName: 'MVCS_SERV_TEMPO_CATEG_ATUAL_ID', allocationSize: 1, initialValue: 1)]
    private $idTable;
