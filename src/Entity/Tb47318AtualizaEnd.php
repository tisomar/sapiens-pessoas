 ...
 * Tb47318AtualizaEnd
 */
#[ORM\Table(name: 'TB_47318_ATUALIZA_END')]
#[ORM\Entity]
class Tb47318AtualizaEnd
{
    /**
     * @var int|null
     */
    ...
    #[ORM\SequenceGenerator(sequenceName: 'TB_47318_ATUALIZA_END_ID_TABLE', allocationSize: 1, initialValue: 1)]
    private $idTable;
