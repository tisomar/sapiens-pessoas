...
/**
 * Documentacao05082010Bkp
 */
#[ORM\Table(name: 'DOCUMENTACAO_05082010_BKP')]
#[ORM\Entity]
class Documentacao05082010Bkp
{
    /**
     * @var int
     */
     ...
     * @var string
     */
    #[ORM\Column(name: 'IN_SITUACAO_DOCUMENTACAO', type: 'string', length: 1, nullable: false, options: ['fixed' => true])]
    private $inSituacaoDocumentacao;
    ...
    #[ORM\SequenceGenerator(sequenceName: 'DOCUMENTACAO_05082010_BKP_ID_T', allocationSize: 1, initialValue: 1)]
    private $idTable;
