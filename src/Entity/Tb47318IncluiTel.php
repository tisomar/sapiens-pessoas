 ...
 * Tb47318IncluiTel
 */
#[ORM\Table(name: 'TB_47318_INCLUI_TEL')]
#[ORM\Entity]
class Tb47318IncluiTel
{
    /**
     * @var int|null
     */
    ...
    #[ORM\SequenceGenerator(sequenceName: 'TB_47318_INCLUI_TEL_ID_TABLE_s', allocationSize: 1, initialValue: 1)]
    private $idTable;
