...
/**
 * TbFuncaoComissionadaOld
 */
#[ORM\Table(name: 'TBFUNCAO_COMISSIONADA_OLD')]
#[ORM\Entity]
class TbFuncaoComissionadaOld
{
    /**
     * @var int
     */
    ...
    #[ORM\SequenceGenerator(sequenceName: 'TBFUNCAO_COMISSIONADA_OLD_ID_T', allocationSize: 1, initialValue: 1)]
    private $idTable;
