...
/**
 * MvcsServProvCatImedAnt
 */
#[ORM\Table(name: 'MVCS_SERV_PROV_CAT_IMED_ANT')]
#[ORM\Entity]
class MvcsServProvCatImedAnt
{
    /**
     * @var int
     */
     ...
     * @var int|null
     */
    #[ORM\Column(name: 'NR_GRAU_PROGR_FUNCIONAL', type: 'integer', nullable: true)]
    private $nrGrauProgrFuncional;

    /**
     * @var int|null
     */
    #[ORM\Column(name: 'TMP_CARR_ANTER_SEM_AFAST', type: 'integer', nullable: true)]
    private $tmpCarrAnterSemAfast;
    ...
    #[ORM\SequenceGenerator(sequenceName: 'MVCS_SERV_PROV_CAT_IMED_ANT_ID', allocationSize: 1, initialValue: 1)]
    private $idTable;
     ...
     * @return int|null
     */
    public function getNrGrauProgrFuncional(): ?int
    {
        return $this->nrGrauProgrFuncional;
    }

    /**
     * @param int|null $nrGrauProgrFuncional
     */
    public function setNrGrauProgrFuncional(?int $nrGrauProgrFuncional): void
    {
        $this->nrGrauProgrFuncional = $nrGrauProgrFuncional;
    }

    /**
     * @return int|null
     */
    public function getTmpCarrAnterSemAfast(): ?int
    {
        return $this->tmpCarrAnterSemAfast;
    }

    /**
     * @param int|null $tmpCarrAnterSemAfast
     */
    public function setTmpCarrAnterSemAfast(?int $tmpCarrAnterSemAfast): void
    {
        $this->tmpCarrAnterSemAfast = $tmpCarrAnterSemAfast;
    }
