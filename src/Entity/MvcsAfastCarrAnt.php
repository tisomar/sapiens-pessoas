 ...
 * MvcsAfastCarrAnt
 */
#[ORM\Table(name: 'MVCS_AFAST_CARR_ANT')]
#[ORM\Entity]
class MvcsAfastCarrAnt
{
    /**
     * @var int
     */
    ...
    #[ORM\SequenceGenerator(sequenceName: 'MVCS_AFAST_CARR_ANT_ID_TABLE_s', allocationSize: 1, initialValue: 1)]
    private $idTable;
