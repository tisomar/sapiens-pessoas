...
/**
 * MvcsAfastCarrAtualTspCons
 */
#[ORM\Table(name: 'MVCS_AFAST_CARR_ATUAL_TSP_CONS')]
#[ORM\Entity]
class MvcsAfastCarrAtualTspCons
{
    /**
     * @var int
     */
    ...
    #[ORM\SequenceGenerator(sequenceName: 'MVCS_AFAST_CARR_ATUAL_TSP_CONS', allocationSize: 1, initialValue: 1)]
    private $idTable;
