...
/**
 * MvcsAfastCarrAtualTsp
 */
#[ORM\Table(name: 'MVCS_AFAST_CARR_ATUAL_TSP')]
#[ORM\Entity]
class MvcsAfastCarrAtualTsp
{
    /**
     * @var int
     */
    ...
    #[ORM\SequenceGenerator(sequenceName: 'MVCS_AFAST_CARR_ATUAL_TSP_ID_T', allocationSize: 1, initialValue: 1)]
    private $idTable;
