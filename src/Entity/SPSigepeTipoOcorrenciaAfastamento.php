...
/**
 * /src/Entity/SPSigepeTipoOcorrenciaAfastamento.php.
 *
...
#[ORM\Table(name: 'SP_SIGEPE_TIPO_OCOR_AFASTA')]
#[Gedmo\Loggable]
class SPSigepeTipoOcorrenciaAfastamento implements EntityInterface
{
    // Traits
    use Id;
    use Uuid;
