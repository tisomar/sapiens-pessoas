...
/**
 * MvcsAfastCatAtualTsp
 */
#[ORM\Table(name: 'MVCS_AFAST_CAT_ATUAL_TSP')]
#[ORM\Entity]
class MvcsAfastCatAtualTsp
{
    /**
     * @var int
     */
    ...
    #[ORM\SequenceGenerator(sequenceName: 'MVCS_AFAST_CAT_ATUAL_TSP_ID_TA', allocationSize: 1, initialValue: 1)]
    private $idTable;
