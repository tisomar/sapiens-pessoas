...
class ToUpper extends BaseFilter
{
     ...
     * {@inheritDoc}
     *
     * @param \AguPessoas\Backend\Bundles\DMS\Filter\Rules\ToUpper $rule
     */
     ...
     */
    public function useEncoding(\AguPessoas\Backend\Bundles\DMS\Filter\Rules\ToUpper $rule): bool
    {
