...
use AguPessoas\Backend\Bundles\DMS\Filter\Exception\FilterException;
...
class ToLower extends BaseFilter
{
     ...
     * {@inheritDoc}
     *
     * @param \AguPessoas\Backend\Bundles\DMS\Filter\Rules\ToLower $rule
     */
     ...
     */
    public function useEncoding(\AguPessoas\Backend\Bundles\DMS\Filter\Rules\ToLower $rule): bool
    {
