...
namespace AguPessoas\Backend\Bundles\DMS\Filter;

/**
 * Filter Object, responsible for retrieving the filtering rules
 * for the object and applying them
 */
use AguPessoas\Backend\Bundles\DMS\Filter\Filters\Loader\FilterLoaderInterface;
use AguPessoas\Backend\Bundles\DMS\Filter\Mapping\ClassMetadataFactoryInterface;
